...
const NavBar = ({ user }) => {
   ...
   * This implements a browser-native "Find in Page" feature directly in the React app.
   * It uses DOM manipulation to highlight text matches across the entire page content.
   * 
   * Why DOM manipulation here:
   ...
   * - This allows custom styling and navigation of search results
   * 
   * Trade-offs:
   * - Performance: Fine for text-heavy pages, may slow on extremely large content
   * - Maintenance: Requires careful cleanup to avoid memory leaks
   * - Alternative: Could use a search modal with filtered results (different UX)
   */
        ...
        <div className="max-w-full mx-auto px-4 relative">
          <div className="flex justify-between items-center h-14">
            ...
            <div className="flex items-center space-x-4">
              ...
              {/* Removed static Gastos/Medios Pago links */}
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              {/* Apps Grid as deployable menu */}
              <div className="relative">
                <button
                  onClick={() =>
                    setIsMenuOpen(isMenuOpen === "apps" ? false : "apps")
                  }
                  className="dashboard p-2 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-md transition-colors"
                >
