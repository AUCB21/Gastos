    ...
    return (
      <div className={`bg-white rounded-lg shadow-sm border p-4 ${className}`}>
        ...
        <button
          ...
          className={`w-full ${getButtonClass('primary', 'regular')} text-sm`}
        >
          Reintentar
        </button>
      </div>
  ...
  if (!inviteLink) {
    return (
      <div className={`bg-white rounded-lg shadow-sm border p-4 ${className}`}>
        <button
          onClick={generateInviteLink}
          className={`w-full ${getButtonClass('primary', 'regular')} text-sm gap-2`}
        >
  ...
  return (
    <div className={`bg-white rounded-lg shadow-sm border p-4 ${className}`}>
      <div className="flex items-center gap-2 mb-3">
        <Share className={`w-5 h-5 ${colors.primary.text}`} />
        <h3 className={`font-semibold ${getTextClass('default')}`}>Enlace de Invitación</h3>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="flex gap-2">
          <input
            ...
            value={inviteLink}
            readOnly
            className={`flex-1 px-3 py-2 border ${colors.border} rounded-lg ${colors.neutral.bg} text-sm focus:outline-none`}
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg transition-colors text-sm ${
              copySuccess
                ...
                : getButtonClass('primary', 'regular')
            }`}
        ...
        <div className="flex gap-2">
          <button
            onClick={generateInviteLink}
            className={`flex items-center gap-2 px-3 py-1 ${getTextClass('muted')} hover:${getTextClass('default')} transition-colors text-sm`}
        ...
        {/* Usage Info */}
        <div className={`text-xs ${getTextClass('light')} ${colors.extra.bg} p-2 rounded`}>
